...
const Home = () => {
  ...
  const handleNewsletterSubscribe = async (e) => {
    ...
    try {
      ...
      setNewsletterStatus({
        type: "error",
        message: err.response?.data?.message || "Errore durante l'iscrizione",
      });
    } finally {
      setNewsletterLoading(false);
      if (
        err.response?.status === 400 &&
        err.response?.data?.message.includes("già iscritto")
      ) {
  ...
  const handleNewsletterDismiss = () => {
    ...
    localStorage.setItem("newsletter_status", "dismissed");
  };
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ gap: "2.5rem", alignItems: "center", display: "none" }}
        >
      ...
      >
        ...
        >
          ...
          >
            Crafting the <br />
            <span className="text-gradient">Next Century</span> of Web
          </motion.h1>
      ...
      <section
        ...
        style={{ padding: "10rem 1.5rem", position: "relative" }}
      >
        ...
        >
          ...
          >
            ...
            >
              <p>
                Sono <strong>Mattia Ghigo</strong>, sviluppatore e studente con
                una forte passione per l’informatica e la tecnologia. Mi occupo
                principalmente di sviluppo software, bot e plugin
                personalizzati, con diversi anni di esperienza pratica in{" "}
                <strong>JavaScript</strong>, <strong>Node.js</strong> e{" "}
                <strong>Discord.js</strong>. Nel tempo ho lavorato anche con C,
                Java e tecnologie web come HTML e CSS, sviluppando progetti
                reali e funzionali orientati alla soluzione di problemi
                concreti.
              </p>
              <p>
                Il mio percorso nasce dalla curiosità: ho iniziato sperimentando
                in autonomia, poi ho rafforzato le competenze con studi tecnici
                in ambito informatico e con un’esperienza diretta come tecnico
                IT, dove ho imparato a ragionare in modo pratico, strutturato e
                orientato ai risultati. Mi piace progettare sistemi chiari,
                efficienti e curati nei dettagli, che non siano solo codice ma
                strumenti utili.
              </p>
              <p>
                Sono una persona pragmatica, costante e orientata alla crescita
                continua. Studio, provo, sbaglio, miglioro. Ogni progetto per me
                è un passo avanti, sia a livello tecnico sia mentale. 🚀
              </p>
            </div>
      ...
      >
        <div style={{ marginBottom: "5rem" }}>
          ...
          <p className="text-muted">
            Il mio percorso nel mondo del tech e oltre.
          </p>
        </div>
          ...
          <div className="flex-col gap-6">
            ...
            >
              <div
                ...
                style={{ padding: "2rem", textAlign: "center", gap: "1rem" }}
              >
                <ShieldCheck size={32} style={{ opacity: 0.3 }} />
                <p style={{ fontSize: "0.8rem", color: "var(--text-dim)" }}>
                  Sempre in aggiornamento con le ultime tecnologie
                  industrial-grade.
                </p>
              </div>
            </div>
          ...
          {[
            {
              name: "Full-Stack Dev",
              icon: <Layout />,
              desc: "Architetture scalabili con React, Next.js e Node.js.",
            },
            {
              name: "UI/UX Design",
              icon: <Settings />,
              desc: "Interfacce minimalist e premium con focus sul core-business.",
            },
            {
              name: "Database Design",
              icon: <Database />,
              desc: "Ottimizzazione e gestione dati con MongoDB e PostgreSQL.",
            },
            {
              name: "Security Audit",
              icon: <ShieldCheck />,
              desc: "Verifica e messa in sicurezza della tua infrastruttura digitale.",
            },
          ].map((s, idx) => (
            <motion.div
              key={idx}
      ...
      <section
        style={{
          padding: "6rem 1.5rem",
          background:
            "linear-gradient(180deg, transparent 0%, rgba(0,229,255,0.05) 100%)",
        }}
      >
        <div
          className="container"
        ...
        >
          ...
          >
            ...
            >
              Dallo sviluppo web alla configurazione server, dai bot Discord
              alle consulenze tecniche. Trova la soluzione perfetta per le tue
              esigenze.
            </p>
            <Link
              to="/shop"
      ...
      >
        ...
        >
          ...
          >
            Disponibile per consulenze e collaborazioni strategiche.
          </p>
          <Link
        ...
        {showNewsletterPopup && (
          ...
          >
            ...
            >
              ...
              >
                Un Regalo <span className="text-gradient">per Te</span>
              </h2>
              <p
                style={{
                  color: "var(--text-muted)",
              ...
              >
                Iscriviti alla newsletter e ricevi immediatamente un{" "}
                <b style={{ color: "white" }}>codice sconto da 30€</b> da
                utilizzare sul nostro store!
              </p>
              ...
              >
                Nessuno spam. Solo aggiornamenti importanti e offerte esclusive.
              </p>
            </motion.div>
          </div>
        )}
