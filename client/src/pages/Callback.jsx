    ...
    const handleCallback = async () => {
      ...
      if (code) {
        try {
          ...
          let provider = isLinking
            ? localStorage.getItem("linking_provider")
          ...
          if (!provider) {
            ...
            console.warn(
              "Provider not detected in localStorage, checking if GitHub...",
            );
            ...
            throw new Error(
              "Provider non identificato. Assicurati di aver effettuato il login tramite i pulsanti del sito.",
            );
          }
