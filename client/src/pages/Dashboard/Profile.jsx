...
const Profile = () => {
  ...
  const handleLink = (provider) => {
    const authUrls = {
      ...
      discord: `https://discord.com/oauth2/authorize?client_id=1468322361093914882&response_type=code&redirect_uri=https%3A%2F%2Fmatty47ghigo-studios.vercel.app%2Fcallback&scope=identify+email+connections`,
  ...
  const handleDeleteAccount = async () => {
    const confirmDelete = confirm(
      "ATTENZIONE: Questa azione è IRREVERSIBILE. Tutti i tuoi dati, ticket e ordini verranno eliminati permanentemente. Vuoi procedere?",
    );
    ...
    <div style={{ maxWidth: "896px" }}>
      ...
      >
        ...
        <div
          ...
          style={{ gridTemplateColumns: "minmax(0, 2fr) minmax(0, 1.2fr)" }}
        >
          {/* General Info */}
          ...
          <div className="flex-col gap-6">
            <div className="card flex-col gap-4">
              <h3
                className="text-lg font-bold mb-4 flex-center"
                style={{ justifyContent: "flex-start", gap: "0.75rem" }}
              >
                <ShieldCheck
                  size={20}
                  style={{
                    color: is2FAEnabled ? "#4ade80" : "white",
                    opacity: 0.8,
                  }}
                />{" "}
                Two-Factor Auth
              ...
              >
                ...
                utilizzando un'app di autenticazione (Google o Microsoft
                Authenticator).
              </p>
            ...
            <div className="card flex-col gap-4">
              <h3
                ...
                style={{ justifyContent: "flex-start", gap: "0.75rem" }}
              >
                <Globe size={20} style={{ color: "#00e5ff" }} /> Account
                Collegati
              </h3>
              <div className="flex-col gap-3">
                ...
                >
                  ...
                  {user.linkedAccounts?.google || user.provider === "google" ? (
                ...
                >
                  ...
                  {user.linkedAccounts?.github || user.provider === "github" ? (
                    <Shield size={14} style={{ color: "#00e5ff" }} />
                  ) : (
                    <button
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: "0.8rem" }}>Discord</span>
                  </div>
            ...
            <div className="card flex-col gap-4">
              ...
              <p
                ...
                style={{ fontSize: "0.75rem", lineHeight: 1.5 }}
              >
                Se desideri eliminare definitivamente il tuo account e tutti i
                dati associati, puoi farlo qui.
              </p>
              <button
              ...
              {backupCodes.length > 0 ? (
                <div className="flex-col gap-6">
                  ...
                  >
                    <ShieldCheck
                      size={40}
                      style={{ color: "#4ade80", margin: "0 auto 1rem" }}
                    />
                    ...
                    >
                      Salva questi codici di backup. Ti serviranno se perdi
                      l'accesso all'app.
                    </p>
                  </div>
                ...
                <div className="flex-col gap-6">
                  <p style={{ fontSize: "0.8rem", color: "var(--text-muted)" }}>
                    Scansiona il QR Code con Google Authenticator o inserisci il
                    segreto manualmente.
                  </p>
                  <div
                    style={{
                  ...
                  />
                  <button onClick={verify2FA} className="btn-primary">
                    Verifica e Abilita
                  </button>
                </div>
              )}
          ...
          >
            ...
            >
              ...
              <p className="text-muted mb-6" style={{ fontSize: "0.8rem" }}>
                Imposta una password per poter accedere al tuo account anche
                tramite email.
              </p>
              <input
                type="password"
