...
const Cart = () => {
  ...
  const handleApplyCoupon = async (e) => {
    ...
    if (result.success) {
      setCouponSuccess(
        `Coupon applicato: -${result.discount.type === "percentage" ? result.discount.value + "%" : "€" + result.discount.value}`,
      );
      setCouponError("");
      setCouponCode("");
    } else {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Non hai ancora aggiunto nessun servizio al carrello. Scopri le
              nostre soluzioni professionali!
            </p>
            <Link
              to="/shop"
        ...
        >
          ...
          >
            ...
            <p style={{ color: "var(--text-muted)", marginBottom: "2rem" }}>
              {cart.length} {cart.length === 1 ? "servizio" : "servizi"} nel
              carrello
            </p>
                  ...
                  {cart.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          onClick={() =>
                            removeFromCart(item.id || item._id, item.options)
                          }
                          style={{
                            background: "transparent",
                            border: "none",
