...
router.post('/checkout/create-session', async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `${process.env.APP_URL || 'http://localhost:5173'}/checkout/success?session_id={CHECKOUT_SESSION_ID}&order_id=${order._id}`,
            cancel_url: `${process.env.APP_URL || 'http://localhost:5173'}/checkout/cancel?order_id=${order._id}`,
